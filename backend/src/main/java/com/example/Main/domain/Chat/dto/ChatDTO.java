...
public class ChatDTO {
    ...
    public ChatDTO(Long roomId, String message, LocalDateTime sendTime,  Long senderId, String senderEmail, String senderName, String senderProfile, String type,String contentType) {
        this.roomId = roomId;
